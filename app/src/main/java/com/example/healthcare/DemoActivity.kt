...
//    private var remoteServer: RemoteServer? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadIndirectLight(this, "venetian_crossroads_2k")
        ...
        createIndirectLight()
        Log.d("nativeObject", modelViewer.scene.nativeObject.toString())
...
//        remoteServer = RemoteServer(8082)
    ...
    private fun loadIndirectLight(context: Context, ibl: String)
    {
    ...
    private fun createDefaultRenderables() {
        ...
        val buffer = assets.open(uri).use { input ->
            val bytes = ByteArray(input.available())
            input.read(bytes)
...
//            modelViewer.loadModelGltf(buffer) { uri -> readCompressedAsset("models/$uri") }
        ...
        Log.d("materialInstances",myInstance.toString())
        updateRootTransform()
    }
